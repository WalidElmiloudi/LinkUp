            ...
            <div class="p-6 md:p-8">
                ...
                <div id="success-message" class="hidden mb-6 p-4 rounded-lg border border-green-200 bg-green-50">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            <p class="text-sm font-medium text-green-800">Votre mot de passe a été réinitialisé avec succès
                                !</p>
                ...
                <form method="post" action="{{ route('password.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="password" name="password"
                                ...
                                placeholder="Saisissez votre nouveau mot de passe" required minlength="8">
                            <button type="button" class="absolute inset-y-0 right-0 pr-3 flex items-center"
                                id="toggle-new-password" aria-label="Afficher/masquer le mot de passe">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <button type="button" class="absolute inset-y-0 right-0 pr-3 flex items-center"
                                id="toggle-confirm-password" aria-label="Afficher/masquer le mot de passe">
                                <i class="fas fa-eye text-gray-400 hover:text-gray-600"></i>
                            </button>
                        </div>
