                        ...
                        <div class="bg-white p-4 rounded-lg border border-gray-200">
                            @if ($post->image)
                                <div class="text-center">
                                    ...
                                    <img src="{{ Storage::url($post->image) }}" alt="Image de la publication"
            ...
            <form method="POST" action="{{ route('post.update', $post->id) }}" enctype="multipart/form-data"
                ...
                <div class="space-y-8">
                    <div>
                        ...
                        <textarea name="description" id="description" rows="6" placeholder="Modifiez votre description ici..."
                        ...
                        <div class="space-y-4">
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <label class="media-option cursor-pointer">
                                    ...
                                    <div
                                        class="border-2 border-gray-200 rounded-lg p-4 text-center hover:border-indigo-300 peer-checked:border-indigo-500 peer-checked:bg-indigo-50 transition-all">
                            ...
                            <div id="image-upload-section">
                                <div class="border-2 border-dashed border-gray-300 rounded-lg p-6">
                                    <div class="text-center">
                                        ...
                                        <p class="text-sm text-gray-500 mb-4">Glissez-déposez ou cliquez pour sélectionner
                                        </p>
                                        ...
                                        <p class="text-xs text-gray-400 mt-2">Taille max : 5MB • Formats : JPG, PNG, GIF,
                                            WebP</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="video-upload-section">
                                <div class="border-2 border-dashed border-gray-300 rounded-lg p-6">
                                    <div class="text-center">
                                        ...
                                        <p class="text-sm text-gray-500 mb-4">Sélectionnez une vidéo depuis votre appareil
                                        </p>

                                        <input type="file" name="video" id="video-input" accept="video/*"
                                            class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-medium file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100">

                                        <p class="text-xs text-gray-400 mt-2">Taille max : 10MB • Formats : MP4, AVI, MOV,
                                            MPEG</p>
                                    </div>
                                </div>
                            </div>
                ...
                <div
                    class="mt-8 pt-6 border-t border-gray-200 flex flex-col sm:flex-row justify-between space-y-4 sm:space-y-0 sm:space-x-4">
